...
'/home/nupic/nta/eng/lib/python2.7/site-packages/nupic/frameworks/opf/exp_generator/ExpGenerator.pyc'
"""
...
permutations = {
  ...
  'modelParams': {
    ...
    'sensorParams': {
      'encoders': {
          u'dy': PermuteEncoder(fieldName='dy', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(28, 521), ),
  u'y': PermuteEncoder(fieldName='y', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(28, 521), ),
  u'ydot': PermuteEncoder(fieldName='ydot', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(28, 521), ),
  u'speed_y': PermuteEncoder(fieldName='speed_y', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(28, 521), ),
  '_classifierInput': dict(classifierOnly=True, fieldname='speed_y', w=21, clipInput=True, type='AdaptiveScalarEncoder', n=PermuteInt(28, 521), ),
  u'pred_speed_y': PermuteEncoder(fieldName='pred_speed_y', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(28, 521), ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=speed_y")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=speed_y"
