...
control = {
  ...
  #
  'dataset' : {   u'info': u'pendulum',
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'pendulum.csv',
                            u'last_record': 10000,
                            u'source': u'file://pilot/pendulum.csv'}],
        u'version': 1},
 ...
 u'predictedField': u'theta',
 u'predictionSteps': [1]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'theta', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'theta', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
