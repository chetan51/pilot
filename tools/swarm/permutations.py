...
permutations = {
  ...
  'modelParams': {
    ...
    'sensorParams': {
      'encoders': {
          u'theta': PermuteEncoder(fieldName='theta', w=21, clipInput=True, encoderClass='AdaptiveScalarEncoder', n=PermuteInt(28, 521), ),
  '_classifierInput': dict(classifierOnly=True, fieldname='theta', w=21, clipInput=True, type='AdaptiveScalarEncoder', n=PermuteInt(28, 521), ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=theta")
minimize = "multiStepBestPredictions:multiStep:errorMetric='altMAPE':steps=\[1\]:window=1000:field=theta"
